...
{
    UIViewController *vc = [AppContext controller];

    if ([vc respondsToSelector:@selector(DaohanglanViewLeftBtnFangfaIsPush:)] && ![vc respondsToSelector:@selector(canMoveBack)]) {
        [vc performSelector:@selector(DaohanglanViewLeftBtnFangfaIsPush:) withObject:nil];
    }
...
- (void)paningGestureReceive:(UIPanGestureRecognizer *)recoginzer
{
    ...
    if (recoginzer.state == UIGestureRecognizerStateBegan) {
        ...
        UIViewController *vc = [AppContext controller];
        if ([vc respondsToSelector:@selector(canMoveBack)]) {
            _isMoving = NO;
            return;
        }
