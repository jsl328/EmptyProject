...
-(void) layoutSubviews {
    ...
    //    int padding = _messageLabel.text ? 5 : 0;
    //    int top = (window.frame.size.height - (_activityIndicator.frame.size.height + padding + messageSize.height)) / 2;
    
    bgView.frame = CGRectMake(0, 0, window.frame.size.width, window.frame.size.height);
    //    _activityIndicator.frame = CGRectMake((window.frame.size.width - _activityIndicator.frame.size.width) / 2, top, _activityIndicator.frame.size.width, _activityIndicator.frame.size.height);
    //    _messageLabel.frame = CGRectMake((window.frame.size.width - messageSize.width) / 2, top + _activityIndicator.frame.size.height + padding, messageSize.width, messageSize.height);
